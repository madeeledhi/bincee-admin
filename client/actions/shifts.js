...
export const createShift = ({ shift_name, start_time, end_time, token }) => ({
  [CALL_API]: {
    ...
    endpoint: 'https://bincee-server.herokuapp.com/api/school/shift/create',
    method: 'POST',
    token,
  },
...
export const editShift = ({ id, shift_name, start_time, end_time, token }) => ({
  [CALL_API]: {
    ...
    endpoint: `https://bincee-server.herokuapp.com/api/school/shift/${id}`,
    method: 'POST',
    token,
  },
  payload: { shift_name, start_time, end_time },
...
export const loadShifts = ({ token }) => ({
  [CALL_API]: {
    ...
    endpoint: 'https://bincee-server.herokuapp.com/api/school/shift/list',
    method: 'GET',
    token,
  },
  payload: {},
